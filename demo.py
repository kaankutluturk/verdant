...
def demo_hardware_detection():
    ...
    try:
        from verdant import HardwareDetector
...
def demo_model_management():
    ...
    try:
        from verdant import ModelDownloader, MODELS
        ...
        if model_path:
            ...
            print(f"   Run 'python verdant.py --setup' to download")
...
def demo_cli_interface():
    ...
    try:
        ...
        print("\nExample Usage:")
        print("  python verdant.py --setup")
        print("  python verdant.py --interactive")
        print("  python verdant.py --prompt 'Hello, how are you?'")
...
def main():
    """Run all demos."""
    print("🚀 Verdant MVP Feature Demo")
    print("=" * 50)
    print("This demo shows the working features of Verdant MVP")
    ...
    if passed == total:
        print("\n🎉 All demos passed! Verdant MVP is working correctly.")
        print("\n📖 To get started with the full AI experience:")
        print("   1. Install dependencies: pip install -r requirements.txt")
        print("   2. Download model: python verdant.py --setup")
        print("   3. Start chatting: python verdant.py --interactive")
    else:
